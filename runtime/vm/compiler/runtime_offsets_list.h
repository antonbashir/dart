...
#define COMMON_OFFSETS_LIST(FIELD, ARRAY, SIZEOF, ARRAY_SIZEOF, PAYLOAD_SIZEOF, RANGE, CONSTANT)                                                                        \
    ...
    RANGE(Function, entry_point_offset, CodeEntryKind, CodeEntryKind::kNormal, CodeEntryKind::kUnchecked, [](CodeEntryKind value) { return true; })                     \
    ...
    RANGE(Code, entry_point_offset, CodeEntryKind, CodeEntryKind::kNormal, CodeEntryKind::kMonomorphicUnchecked, [](CodeEntryKind value) { return true; })              \
    RANGE(Thread, write_barrier_wrappers_thread_offset, Register, 0, kNumberOfCpuRegisters - 1, [](Register reg) { return (kDartAvailableCpuRegs & (1 << reg)) != 0; }) \
    ...
    SIZEOF(CompressedStackMaps, PayloadHeaderSize, UntaggedCompressedStackMaps::Payload::FlagsAndSizeHeader)                                                            \
    ...
    SIZEOF(InstructionsSection, UnalignedHeaderSize, UntaggedInstructionsSection)                                                                                       \
    ...
    SIZEOF(WeakSerializationReference, InstanceSize, UntaggedWeakSerializationReference)                                                                                \
